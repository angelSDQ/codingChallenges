...
public class cc2 {
    ...
    public static boolean palindromeChecker(String inputP) {
        String palindromeWord = "";
        for (int i = 0; i < inputP.length(); i++) {
            palindromeWord = inputP.charAt(i) + palindromeWord;        
        }
        if (palindromeWord.toLowerCase().equals(inputP.toLowerCase())) {
            return true;
        } else {
            return false;
        }
