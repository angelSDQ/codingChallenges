...
// create a funtion numbersDivisibleByAandB() passing 3 parameters (nums, a, b)
// function numbersDivisibleByAandB(nums, a, b) {
//      create a variable findingDivisibleNums of let type set to []
//      let findingDivisibleNums = [];
//      use a for loop to iterate on findingDivisibleNums
//      for (let num of nums) {
//          use an if statement to check for the condition (num % a == 0 && num % b == 0)
//          if (num % a == 0 && num % b == 0) {
//              when true, to populate findingDivisibleNums use .push passing in num
//              findingDivisibleNums.push(num);
//          }
//      }
...
console.log(numbersDivisibleByAandB([4, 6, 8, 12, 18], 2, 3))